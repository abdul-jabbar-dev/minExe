        ...
        <div className='container mx-auto grid md:grid-cols-12  gap-4 py-12 pl-12' style={{ backgroundColor: "#f7f8fa", borderRadius: "15px" }}>
            ...
            <div className='banner-section md:col-span-6 sm:col-span-12 col-span-7'>
                <div className='inner-banner-section'>
                    ...
                    <p className='cstm-primiry-TC first-line:uppercase first-line:tracking-widest
  first-letter:text-5xl first-letter:font-normal first-letter:text-slate-900
  first-letter:mr-1 first-letter:float-left'>ক্লাস ১-১২, ভর্তি পরীক্ষা, বিশ্ববিদ্যালয় ও চাকরি জীবনের জন্য পাবে স্পেশাল কোর্স, মডেল টেস্টসহ ২৪/৭ দিকনির্দেশনা। <span className='cstm-secondary-TC font-bold '>সিলেক্ট করো তোমার সেকশন, শুরু করো তোমার জার্নি</span></p>
                </div>
